...
Realistic MDM defects: duplicates, format variations, typos, missing fields.
"""
import csv
import random
import os
...
CITIES      = ["Dubai","dubai","DUBAI","Abu Dhabi","Sharjah","London","london","New York","New York City"]
COUNTRIES   = ["UAE","AE","United Arab Emirates","UK","GB","United Kingdom","US","USA","United States"]
PHONES      = ["+971-50-1234567","+971501234567","00971501234567","971501234567","050-1234567"]
