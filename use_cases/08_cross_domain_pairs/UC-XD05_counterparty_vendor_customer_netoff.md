...
## Summary
Apex Group (Apex) Group is simultaneously:
- A **customer** (Apex Retail buys corporate gifting products from the company)
- A **vendor** (Apex's logistics arm delivers goods to the company's stores)
- A **counterparty** (Apex has a treasury FX forward contract with the company)
...
- Relationship strategy: the CEO negotiating a new deal with Apex has no visibility that the company also owes Apex AED 1.5M in payables — negotiating from a position of false strength
- Sanctions: if Apex were added to a sanctions list, all three exposures must be frozen simultaneously

## Scenario Setup

| Domain | Record | Role | Exposure |
|--------|--------|------|----------|
| Customer | GLD-CUST-00890 | Apex Retail (buyer) | AED 850K receivable |
| Vendor | GLD-VEND-00445 | Apex Logistics (supplier) | AED 1.5M payable |
| Counterparty | GLD-CP-00789 | Apex Treasury (FX forward) | AED 200K MTM gain |
...
- Net exposure calculated: AED 850K (AR) - AED 1.5M (AP) + AED 200K (MTM) = **AED -450K net payable to Apex**

**UNFURL** — Treasury receives the unified Apex exposure dashboard:
```
Apex Group — Unified Exposure
  Customer (Apex Retail):       AED +850K  AR
  Vendor (Apex Logistics):      AED -1.5M  AP
...
Nadia (Governance) and Tariq (Security) jointly sign off the three-way link. Treasury CFO reviews the net exposure — confirms netting agreement is in place with Apex. Credit limit updated to reflect net position. Basel III large exposure calculation re-run with the correct consolidated exposure.

## Validated Three-Domain View

```
Apex Group (Legal Entity)
